  ...
  */
  ...
  for ( n=nfirst; n<= nlast; n+=ninc ){
    ...
    *( ( double * ) FLA_Obj_buffer_at_view( delta ) ) = d_n;
	...
	REF_LU( TIME_LAPACK, Aref, nb_alg );
  ...
  printf( "plot( data_REF( :,1 ), data_REF( :, 2 ), ':k*;reference;' ); \n" );
...
#endif
#if TIME_UNB_VAR4 == TRUE
  printf( "plot( data_unb_var4( :,1 ), data_unb_var4( :, 2 ), \"-k+;UnbVar4;\" ); \n" );
#endif
#if TIME_UNB_VAR5 == TRUE
  printf( "plot( data_unb_var5( :,1 ), data_unb_var5( :, 2 ), \"-mv;UnbVar5;\" ); \n" );
#endif
#if TIME_BLK_VAR1 == TRUE
...
#endif
#if TIME_BLK_VAR4 == TRUE
  printf( "plot( data_blk_var4( :,1 ), data_blk_var4( :, 2 ), \"-k+;BlkVar4;\", \"markersize\", 3  ); \n" );
#endif
#if TIME_BLK_VAR5 == TRUE
  printf( "plot( data_blk_var5( :,1 ), data_blk_var5( :, 2 ), \"-mv;BlkVar5;\", \"markersize\", 3  ); \n" );
#endif
#else
  ...
  printf(" print -landscape -solid -color -deps -F:24 LU.eps\n" );
#else
  printf( "legend( 'FLA LU', ...\n");
  printf( "        'Simple loops', ...\n");
  printf( "        'unb var1', ...\n");
  printf( "        'unb var2', ...\n");
  printf( "        'unb var3', ...\n");
